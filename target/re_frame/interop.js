...
return [(function (){var pred__13750 = cljs.core.instance_QMARK_;
var expr__13751 = reactive_val;
if(cljs.core.truth_(pred__13750.call(null,reagent.ratom.RAtom,expr__13751))){
return "ra";
} else {
if(cljs.core.truth_(pred__13750.call(null,reagent.ratom.RCursor,expr__13751))){
return "rc";
} else {
if(cljs.core.truth_(pred__13750.call(null,reagent.ratom.Reaction,expr__13751))){
return "rx";
} else {
if(cljs.core.truth_(pred__13750.call(null,reagent.ratom.Track,expr__13751))){
return "tr";
} else {
return "other";
}
