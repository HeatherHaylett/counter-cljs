...
var or__10778__auto__ = w.requestAnimationFrame;
if(cljs.core.truth_(or__10778__auto__)){
return or__10778__auto__;
} else {
var or__10778__auto____$1 = w.webkitRequestAnimationFrame;
if(cljs.core.truth_(or__10778__auto____$1)){
return or__10778__auto____$1;
} else {
var or__10778__auto____$2 = w.mozRequestAnimationFrame;
if(cljs.core.truth_(or__10778__auto____$2)){
return or__10778__auto____$2;
} else {
var or__10778__auto____$3 = w.msRequestAnimationFrame;
if(cljs.core.truth_(or__10778__auto____$3)){
return or__10778__auto____$3;
} else {
...
var n__11859__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__11859__auto__)){
(fs[i]).call(null);
...
(reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__11455__auto__,writer__11456__auto__,opt__11457__auto__){
return cljs.core._write.call(null,writer__11456__auto__,"reagent.impl.batching/RenderQueue");
}));
