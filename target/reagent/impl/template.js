...
(reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__11455__auto__,writer__11456__auto__,opt__11457__auto__){
return cljs.core._write.call(null,writer__11456__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__16352 = o;
goog.object.set(G__16352,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__16354__i < G__16354__a.length) {G__16354__a[G__16354__i] = arguments[G__16354__i + 0]; ++G__16354__i;}
  args = new cljs.core.IndexedSeq(G__16354__a,0,null);
} 
...
var G__16356 = o;
goog.object.set(G__16356,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__16360 = props;
var G__16360__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__16360,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16360);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__16360__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__16360__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__16361 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__16361,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__16361;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__16362){
...
var on_write = cljs.core.get.call(null,map__16363__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
if(cljs.core.truth_((((!((jsprops == null))))?(function (){var and__10763__auto__ = jsprops.hasOwnProperty("onChange");
...
return (jsprops.onChange = (function (p1__16365_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__16365_SHARP_);
}));
} else {
return null;
}
...
(reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__11455__auto__,writer__11456__auto__,opt__11457__auto__){
return cljs.core._write.call(null,writer__11456__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__16368 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__16368,(0),null);
var id = cljs.core.nth.call(null,vec__16368,(1),null);
var className = cljs.core.nth.call(null,vec__16368,(2),null);
...
var temp__5739__auto___16372 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___16372 == null)){
} else {
var key_16373 = temp__5739__auto___16372;
(jsprops.key = key_16373);
}
...
var jsprops = (function (){var or__10778__auto__ = reagent.impl.template.convert_prop_value.call(null,((hasprops)?props:null));
...
var temp__5739__auto___16374 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___16374 == null)){
} else {
var key_16375 = temp__5739__auto___16374;
(jsprops.key = key_16375);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_.call(null,props)));
var jsprops = (function (){var or__10778__auto__ = reagent.impl.template.convert_props.call(null,((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__10778__auto__)){
return or__10778__auto__;
} else {
return ({});
...
var temp__5739__auto___16376 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___16376 == null)){
} else {
var key_16377 = temp__5739__auto___16376;
(jsprops.key = key_16377);
}
...
var G__16379 = n;
if(cljs.core._EQ_.call(null,"",G__16379)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__16379)){
return x;
} else {
...
var len__12100__auto___16382 = arguments.length;
var i__12101__auto___16383 = (0);
while(true){
if((i__12101__auto___16383 < len__12100__auto___16382)){
args__12110__auto__.push((arguments[i__12101__auto___16383]));

var G__16384 = (i__12101__auto___16383 + (1));
i__12101__auto___16383 = G__16384;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__12111__auto__);
});
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq16380){
...
return self__12085__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16381,seq16380__$1);
}));
...
break;
default:
var G__16387 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__16387;
continue;
...
var ctx = ({});
var vec__16389 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__16389,(0),null);
var derefed = cljs.core.nth.call(null,vec__16389,(1),null);
...
var G__16392 = (cljs.core.count.call(null,argv) - first_child);
switch (G__16392) {
case (0):
